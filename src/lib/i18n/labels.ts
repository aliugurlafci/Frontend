...
const ENTITY: Record<"tr" | "de", Record<string, Pair>> = {
  tr: {
    ...
    cart: { s: "Sepet", p: "Sepetler" },
    salesOrder: { s: "Sipariş", p: "Siparişler" },
    salesReturn: { s: "İade", p: "İadeler" },
  ...
  de: {
    ...
    cart: { s: "Warenkorb", p: "Warenkörbe" },
    salesOrder: { s: "Bestellung", p: "Bestellungen" },
    salesReturn: { s: "Retoure", p: "Retouren" },
...
const FIELD: Record<"tr" | "de", Record<string, string>> = {
  tr: {
    ...
    address: "Adres", managerId: "Yönetici",
    ...
    approverId: "Onaylayan", approvedAt: "Onay Tarihi", rejectionReason: "Reddetme Nedeni",
  ...
  de: {
    ...
    address: "Adresse", managerId: "Manager",
    ...
    approverId: "Genehmiger", approvedAt: "Genehmigt am", rejectionReason: "Ablehnungsgrund",
